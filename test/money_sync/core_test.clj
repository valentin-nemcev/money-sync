...
(deftest parse-transactions
  (is (= (list {"Тип счёта"         "Текущий счёт",
               ...
               {"Тип счёта"         "Текущий счёт",
                ...
                "Описание операции"
                "510126++++++4656    24064401\\RUS\\ARTGORBUNOV R\\ARTGORBUNOV            10.06.17 08.06.17        50.00  RUR MCC8299",
                "Приход" "0",
                "Расход" "50",
                "" ""}
              {"Тип счёта" "Текущий счёт",
                ...
                "Описание операции"
                "Ком.за пер.с исп.рас.карты ОАО\"АЛЬФА-БАНК \",вып.к Тек.сч.Кл.,на сч.карты стор.банк.Согл.тар.Банка Немцев Валентин Николаевич",
                "Приход" "0",
                "Расход" "30",
                "" ""}
              {"Тип счёта" "Текущий счёт",
